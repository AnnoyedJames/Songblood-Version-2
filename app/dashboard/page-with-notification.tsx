...
import CriticalInventoryNotification from "@/components/critical-inventory-notification"
...
export default async function DashboardPage() {
  try {
    ...
    try {
      ...
      // Prepare combined inventory data for alerts
      ...
      return (
        <div className="min-h-screen flex flex-col">
          ...
          <main className="flex-1 container py-6 px-4 md:py-8">
            ...
            <CriticalInventoryNotification inventory={combinedInventory} />
            ...
            <div className="grid gap-6 lg:grid-cols-3 mb-8">
              ...
              <div className="space-y-6">
                <Suspense fallback={<Skeleton className="w-full h-[200px] rounded-lg" />}>
                  <InventoryAlerts inventory={combinedInventory} />
                </Suspense>
                <Suspense fallback={<Skeleton className="w-full h-[200px] rounded-lg" />}>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Suspense fallback={<Skeleton className="w-full h-64 rounded-lg" />}>
                <InventoryTable title="Plasma Inventory" inventory={plasma} showRh={true} />
              </Suspense>
