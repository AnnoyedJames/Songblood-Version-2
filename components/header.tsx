...
export default function Header({ hospitalId, hospitalName = "Hospital" }: HeaderProps) {
  return (
    <header className="bg-white border-b sticky top-0 z-10">
      <div className="container flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm md:text-base truncate max-w-[200px] md:max-w-none">{hospitalName}</span>
        </div>
