...
import { AlertCircle, CheckCircle2, RefreshCw, Trash2, Undo2, X } from "lucide-react"
...
export default function DeleteEditContent() {
  ...
  const handleSaveEntry = async (updatedEntry: BloodEntry) => {
    try {
      ...
      if (result.success) {
        setActionMessage({
          type: "success",
          text: result.message || "Entry updated successfully",
        })
        ...
        const errorMessage = result.error || "Failed to update entry"
        setActionMessage({
          type: "error",
          text: errorMessage,
        })
    ...
    <div className="space-y-6">
      ...
      {actionMessage && (
        ...
        >
          ...
          <Button variant="ghost" size="sm" className="h-8 w-8 p-0 rounded-full" onClick={() => setActionMessage(null)}>
            ...
            <TabsContent value="active">
              ...
              <div className="bg-slate-50 p-4 rounded-md mb-6">
                ...
                <div className="mt-4 flex justify-end">
                  ...
                  <Button onClick={fetchInventoryData} className="flex items-center" disabled={isLoading}>
